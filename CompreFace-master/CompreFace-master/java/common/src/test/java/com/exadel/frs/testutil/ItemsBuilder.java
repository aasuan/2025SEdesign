...
public class ItemsBuilder {
    ...
    private static final String DEFAULT_CALCULATOR = "Facenet2018";
    ...
    public static Embedding makeEmbedding(String subjectName, String apiKey) {
        return makeEmbedding(makeSubject(apiKey, subjectName), makeImg());
    }

    public static Embedding makeEmbedding(UUID embeddingId, String subjectName, String apiKey) {
        return makeEmbedding(makeSubject(apiKey, subjectName), makeImg()).setId(embeddingId);
    }
    ...
    public static Embedding makeEmbedding(Subject subject, String calculator, double[] embedding, Img img) {
        return new Embedding()
                ...
                .setCalculator(calculator != null ? calculator : DEFAULT_CALCULATOR)
                .setImg(img);
    }
    ...
    public static Img makeImg(byte[] content) {
        return new Img().setContent(content);
    }
