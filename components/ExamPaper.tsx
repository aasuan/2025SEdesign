          ...
          {qData && (
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-4">
                ...
                {(qData.questionType === 'SingleChoice' || qData.questionType === 'TrueFalse') && qData.options?.map((opt, i) => (
                  <label 
                    key={i} 
                    className={`flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all ${
                      answers[qData.questionId] === opt 
                  ...
                  >
                    <input
                      ...
                      value={opt}
                      checked={answers[qData.questionId] === opt}
                ...
                {(qData.questionType === 'ShortAnswer' || qData.questionType === 'Programming') && (
                  <textarea
