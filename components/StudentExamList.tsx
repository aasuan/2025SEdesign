...
import { Calendar, Clock, ChevronRight, CheckCircle, AlertCircle, Play, History } from 'lucide-react';
      ...
      <div className="flex border-b border-gray-200 mb-6">
        <button
          ...
          className={`pb-3 px-6 text-sm font-medium transition-colors relative ${
            activeTab === 'todo' ? 'text-primary border-b-2 border-primary' : 'text-gray-500 hover:text-gray-700'
          }`}
        >
          待参加考试
        </button>
